...
if __name__ == "__main__":
    client = OpenAI(
        api_key="sk-iquemfpqxtlzhjgyipywfgentevvzbvpjbfxzashumbwzenc",
    ...
    agent = Agent(
        ...
        tools=[add, count_letter_in_string, compare, get_current_datetime, search_wikipedia, get_current_temperature],
    )
